...
export class WorkflowEngine {
  ...
  async startCampaignGenerationWorkflow(campaignData: any) {
    ...
    try {
      ...
      eventBus.emit("VISUAL_CREATED", { campaign_id: campaignData.id });
      ...
      eventBus.emit("CAMPAIGN_GENERATED", { title: campaignData.title });
